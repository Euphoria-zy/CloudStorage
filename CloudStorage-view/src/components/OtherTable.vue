                    ...
                    <template #default="scope">
                        <el-row>
                            <el-tooltip class="item" effect="light" content="下载" placement="bottom-start">
                                <el-button type="success" size="small" :icon="Download" circle @click="handleDownLoad(scope.row)">
        ...
        enterFolder(nowFolderId){
            ...
            API.enterFolder(params).then(
                function(res){
                    if (res.flag){
                        this.$message({message: res.msg, type:"success"});
                        this.folderData = res.data.folderData;
                        this.nowCopyFolder = res.data.nowFolder;
                        this.folderLevel = res.data.location;
                    }else{
                        this.$message.error(res.msg);
                    }
                }
